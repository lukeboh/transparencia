...
echo -e "\033[36m3. Compilando dados brutos para o dashboard...\033[0m"
node src/tse/buildDashboardData.js

echo -e "\033[36m4. Verificando dependências da aplicação web...\033[0m"
if [ ! -d "web/node_modules" ]; then
    (cd web && npm install)
fi

echo -e "\033[32m5. Iniciando servidor do portal de transparência (http://localhost:3000)...\033[0m"
cd web
npm run dev
