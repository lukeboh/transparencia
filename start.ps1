...
Write-Host "3. Compilando dados brutos para o dashboard..." -ForegroundColor Cyan
node src/tse/buildDashboardData.js

Write-Host "4. Verificando dependencias da aplicacao web..." -ForegroundColor Cyan
...
Write-Host "5. Iniciando servidor do portal de transparencia (http://localhost:3000)..." -ForegroundColor Green
Set-Location web
npm run dev
